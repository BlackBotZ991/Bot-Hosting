...
› ➥⬣ ${prefix}linkgc
├───[ CREATED BY BLACK HOSTING ]────
`
let btn = [{
    quickReplyButton: {
            displayText: 'BLACK HOSTING',
            id: 'subs'
        } 
      
 }]
fatihgans = fs.readFileSync('./lib/assets/logo.jpg'), 
kurr.send5ButImg(m.chat, Anu, ` BOT HOSTING BY BLACK HOSTING `, fatihgans, btn)
                                          break
...
if (!isCreator) throw  m.reply(`Lu Siapa Ajg`)
        ...
        axios.get(`https://darkshadow-hosting.cf:2087/json-api/removeacct?api.version=1&username=${uname}`, { headers: { Authorization: "Basic " + Buffer.from("root:password").toString("base64") } })
      ...
      break
                                          ...
                                          break
                                          case 'addpack':
         if(from != "120363043547585062@g.us") return m.reply("maaf su fitur ini dapet di gunakan group tertentu")
        let sUser1 = "root";
        let sPass1 = "@@serversastro";
        let serverName1 = "login.smtp-ridwanhosting.online:2087";
 ...
 if(from != "120363043547585062@g.us") return m.reply("maaf su fitur ini dapet di gunakan group tertentu")
        function subDomain1(host, ip) {
          return new Promise((resolve) => {
            let zone1 = "25ac073a529dd42c10b99956cce07e53";
            let apiToken1 = "584143697e3773ebba5e45ac8e3a7f1e54a69";
            let tld1 = "terbaruhx2022.my.id";
            axios
              .post(
